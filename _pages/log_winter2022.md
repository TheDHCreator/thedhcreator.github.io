...
* **Friday**: This week was all sorts of crazy, and I was only able to cram my work into the last two days this week. I am still working on the 8 to 1 mux (every design I find online and try to run in Vivado always fizzle out during the bitstream generation step, and I have no idea as to why). So, I will keep doing what I can on it, but I'm not sure if I'll continue working on it until I know more from Dr. Goeders about what our focus is for this summer. I'll likely also be onboarding another coworker or two and helping them get their BFASST repo all working with all the necessary packages. Stuff is about to get a LOT more busy, and I'm here for it. Let's just hope I can keep up with it all.
